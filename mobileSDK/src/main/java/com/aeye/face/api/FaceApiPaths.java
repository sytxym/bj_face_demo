...
public final class FaceApiPaths {
    ...
    /** POST {@code {businessCode, authRecordId, verifyTerminal}} 动作活体配置 */
    ...
    /** POST {@code /faceRecord/queryVerifyResult} 查询核验结果状态 */
    public static final String QUERY_VERIFY_RESULT = "/faceRecord/queryVerifyResult";
