...
public final class FaceSdkHostParamBuilder {
    ...
    private static final int DEFAULT_MOTION_TIMEOUT_SEC = 10;
    /** 连续多少帧未检测到人脸才提示（约 1～1.5s，过短会和动作口令来回跳） */
    private static final int DEFAULT_LOST_FACE = 18;
    /**
     * 活体难度等级：1 最低（阈值最宽松），2 中等，3 最高。
     * 宿主经 {@link #buildBase} / {@link com.aeye.face.AEFaceVerifyFlow} 启动时以此为准。
     */
    public static final int DEFAULT_ALIVE_LEVEL = 2;
